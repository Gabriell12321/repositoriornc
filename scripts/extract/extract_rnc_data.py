...
def extract_rnc_data():
    ...
    try:
        ...
        output_file = data_dir / 'indicadores_dashboard_data.json'
        with open(output_file, 'w', encoding='utf-8') as f:
            json.dump(dashboard_data, f, indent=2, ensure_ascii=False, default=str)

        print(f'\n✅ Dados salvos em: {output_file.relative_to(root)}')
        ...
        chart_output_file = data_dir / 'chart_data_from_indicadores.json'
        with open(chart_output_file, 'w', encoding='utf-8') as f:
            json.dump(chart_data, f, indent=2, ensure_ascii=False)

        print(f'✅ Dados dos gráficos salvos em: {chart_output_file.relative_to(root)}')
