...
def list_rncs():
    ...
    try:
        ...
        columns = (
            ...
            "r.responsavel, r.setor, r.area_responsavel, au.name AS assigned_user_name"
        )
        ...
        formatted_rncs = [
            {
                ...
                'area_responsavel': rnc[14] or 'N/A',  # Área responsável do TXT
                'assigned_user_name': rnc[15],
                'user_name': rnc[12] or 'N/A',  # Para compatibilidade
                'user_department': rnc[13] or 'N/A',  # Para compatibilidade
                'department': rnc[14] or 'N/A',  # Área responsável
